...
def writeToFile():
    ...
    workingAccounts = open('Hit_Accounts.txt', 'w+')
    deadAccounts = open('Bad_Accounts.txt', 'w+')
    nonActiveFile = open('Free_Accounts.txt', 'w+')
    for all in working:
    ...
    print ('--------')
    print ('')
    print ('HIT Accounts : ' + str(len(working)))
    print ('Free Accounts: '+ str(len(notActive)))
    print ('Bad accounts: ' + str(len(dead)))
    print ('')
